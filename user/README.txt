...
CẬP NHẬT CỘNG ĐỒNG KHI CHƯA ĐĂNG NHẬP:
- Người chưa đăng nhập vẫn xem được danh sách bài viết, tìm kiếm, bảng xếp hạng và mở rộng nội dung bằng Xem thêm.
- Ẩn khu vực tạo bài viết ở đầu trang để giao diện giống mẫu.
- Thêm bài viết thứ ba nhằm hoàn thiện bố cục danh sách.
- Yêu thích, bình luận, báo cáo, tạo bài viết, tab Yêu thích và tab Quan tâm đều mở popup yêu cầu đăng nhập.
- Popup đăng nhập giữ đường dẫn quay lại community.html sau khi đăng nhập.
- Khi đã đăng nhập, trang vẫn giữ đầy đủ chức năng tạo bài, yêu thích, bình luận và báo cáo.


CẬP NHẬT GIAO DIỆN LÀM BÀI:
- Bỏ viền xanh ngoài cùng của khung đề thi.
- Bỏ viền chấm quanh tiêu đề và khu vực câu hỏi.
- Chỉ giữ đường phân cách mảnh giữa danh sách câu hỏi và nội dung câu hỏi.
- Khi đã đăng nhập, bấm Làm bài sẽ chuyển thẳng vào đề thi, không hiện thông báo demo.
- Khi chưa đăng nhập, popup yêu cầu đăng nhập vẫn được giữ lại.
